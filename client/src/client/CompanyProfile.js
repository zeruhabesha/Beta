...
import Itequipment from './img/it-equipment-2.jpg';
...
<section id="contact" class="contact cp" style={{overflow: `auto`, padding: `10vh 8vh`}}>
  <div class="container">
    ...
    <p>
      ...
      <img style={{height: `8vh`, width: `10%`, float: `left`}} src={Itequipment} alt="image"/>
    </p>
    <p>
...
{/* <img src={Logo1} style={{width:`40vh`}} alt="Logo"/> */}
    ...
    <h4><i class="fa fa-arrow-circle-right pr-10 colored"></i><b>Our Work</b></h4>
    <p>
